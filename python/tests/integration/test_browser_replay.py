...
class TestBrowserRecordIntegration(unittest.TestCase):
    """Integration test for browser session with screen recording enabled."""
    ...
    def create_session(self):
        """Create a session with screen recording enabled."""
        ...
        session_param.enable_record = True  # Enable screen recording

        print("Creating session with screen recording enabled...")
